...
# race_on = False
# Bet = screen.textinput("TURTLE BET", "What color do you think is winning?")
...
#             if winner == Bet:
#                 print(f"You have won the winning color was {Bet}")
#                 race_on = False
#             else:
#                 print(f"You lost winning color was {winner}")
#                 race_on = False
